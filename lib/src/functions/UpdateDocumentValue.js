...
let UpdateDocumentValue = (() => {
    ...
    let _classThis;
    var UpdateDocumentValue = _classThis = class {
        constructor(firestore) {
            this.firestore = firestore;
        }
        updateDocumentValue(docId, data, collection) {
            return new Promise(async (resolve, reject) => {
                try {
                    const documentRef = (0, firestore_1.doc)(this.firestore, CoopeTypes_1.FirestoreCollections[collection], docId);
    ...
    __setFunctionName(_classThis, "UpdateDocumentValue");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        UpdateDocumentValue = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return UpdateDocumentValue = _classThis;
})();
